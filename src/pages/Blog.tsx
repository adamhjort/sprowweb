  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="relative w-[1440px] mx-auto overflow-hidden">
        ...
        <div className="flex flex-col items-center gap-[100px] pt-[10px] relative">
          {/* Header Content */}
          <div className="flex flex-col items-center gap-[50px] w-[737px]">
            <h1 className="text-[60px] leading-[78px] font-semibold text-[#161616] font-['Chakra_Petch'] text-center">
              Blog
            </h1>
            <p className="text-[20px] leading-[26px] text-[#161616] text-center">
            ...
            <div className="flex flex-wrap justify-center gap-[10px] w-[1200px]">
              {/* Main Categories */}
              <div className="flex flex-wrap justify-center gap-[10px] w-full">
                {CATEGORIES.map((category) => (
                  <button
                    ...
                    className={`flex justify-center items-center px-[30px] py-[10px] rounded-[20px] font-['Chakra_Petch'] text-[14px] leading-[18px] font-semibold text-[#161616] transition-colors whitespace-nowrap
                      ${
          ...
          {/* Blog Posts Grid */}
          <div className="w-[1274px] mx-auto">
            <RecentBlogPosts 
